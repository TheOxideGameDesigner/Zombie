...
@export_range(0, 31) var key_index = 0

@onready var init_height = $visual.position.y
...
func _process(delta):
	...
	var dir = player_cam.global_position - $visual/light.global_position
